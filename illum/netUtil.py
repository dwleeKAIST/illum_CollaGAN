...
def Conv2d(x, ch_out, name, reg=None, use_bias=False):
    ...
    #return tf.layers.conv2d(x, filters=ch_out, kernel_size=(1,1), strides=(1,1), padding="SAME", use_bias=use_bias,data_format=d_form, kernel_initializer=li.xavier_initializer(), kernel_regularizer=reg, name="".join((name,"_Conv")))
...
def Conv1x1(x, ch_out, name, reg=None,use_bias=False):
    ...
    #return tf.layers.conv2d(x, filters=ch_out, kernel_size=(1,1), strides=(1,1), padding="SAME", use_bias=True, data_format=d_form, kernel_initializer=li.xavier_initializer(), kernel_regularizer=reg, name="".join((name,"_Conv1x1")))
